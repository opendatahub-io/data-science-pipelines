...
Managed paths must be regular files, and none of their repository-relative
ancestors may be symlinks. Missing unregistered Docker/YAML scan candidates are
ignored, and symlinked candidates are rejected.
