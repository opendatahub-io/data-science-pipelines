...
func (s *ArtifactServer) generateResponseArtifact(
	...
	case apiv2beta1.GetArtifactRequest_DOWNLOAD:
		...
		shareUrl, err := s.resourceManager.GetSignedUrlWithQueryParams(bucketConfig, secret, expiry, *artifact.Uri, queryParams)
		if err != nil {
			return nil, err
		}
	...
	case apiv2beta1.GetArtifactRequest_RENDER:
		...
		renderUrl, err := s.resourceManager.GetSignedUrlWithQueryParams(bucketConfig, secret, expiry, *artifact.Uri, queryParams)
		if err != nil {
			return nil, err
		}
