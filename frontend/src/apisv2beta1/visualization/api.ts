...
export const VisualizationServiceApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {V2beta1Visualization} visualization 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        visualizationServiceCreateVisualizationV1(namespace: string, visualization: V2beta1Visualization, options: any = {}): FetchArgs {
            ...
            const needsSerialization = (<any>"V2beta1Visualization" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
...
export const VisualizationServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        visualizationServiceCreateVisualizationV1(namespace: string, visualization: V2beta1Visualization, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2beta1Visualization> {
...
export const VisualizationServiceApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        visualizationServiceCreateVisualizationV1(namespace: string, visualization: V2beta1Visualization, options?: any) {
...
export class VisualizationServiceApi extends BaseAPI {
     ...
     */
    public visualizationServiceCreateVisualizationV1(namespace: string, visualization: V2beta1Visualization, options?: any) {
