...
export const RecurringRunServiceApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        recurringRunServiceCreateRecurringRun(recurring_run: V2beta1RecurringRun, options: any = {}): FetchArgs {
            // verify required parameter 'recurring_run' is not null or undefined
            if (recurring_run === null || recurring_run === undefined) {
                throw new RequiredError('recurring_run','Required parameter recurring_run was null or undefined when calling recurringRunServiceCreateRecurringRun.');
            }
            ...
            const needsSerialization = (<any>"V2beta1RecurringRun" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(recurring_run || {}) : (recurring_run || "");
        ...
        recurringRunServiceDeleteRecurringRun(recurring_run_id: string, options: any = {}): FetchArgs {
            ...
            if (recurring_run_id === null || recurring_run_id === undefined) {
                throw new RequiredError('recurring_run_id','Required parameter recurring_run_id was null or undefined when calling recurringRunServiceDeleteRecurringRun.');
            }
            const localVarPath = `/apis/v2beta1/recurringruns/{recurring_run_id}`
                .replace(`{${"recurring_run_id"}}`, encodeURIComponent(String(recurring_run_id)));
            const localVarUrlObj = url.parse(localVarPath, true);
        ...
        recurringRunServiceDisableRecurringRun(recurring_run_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'recurring_run_id' is not null or undefined
            if (recurring_run_id === null || recurring_run_id === undefined) {
                throw new RequiredError('recurring_run_id','Required parameter recurring_run_id was null or undefined when calling recurringRunServiceDisableRecurringRun.');
            }
        ...
        recurringRunServiceEnableRecurringRun(recurring_run_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'recurring_run_id' is not null or undefined
            if (recurring_run_id === null || recurring_run_id === undefined) {
                throw new RequiredError('recurring_run_id','Required parameter recurring_run_id was null or undefined when calling recurringRunServiceEnableRecurringRun.');
            }
        ...
        recurringRunServiceGetRecurringRun(recurring_run_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'recurring_run_id' is not null or undefined
            if (recurring_run_id === null || recurring_run_id === undefined) {
                throw new RequiredError('recurring_run_id','Required parameter recurring_run_id was null or undefined when calling recurringRunServiceGetRecurringRun.');
            }
            const localVarPath = `/apis/v2beta1/recurringruns/{recurring_run_id}`
                .replace(`{${"recurring_run_id"}}`, encodeURIComponent(String(recurring_run_id)));
            const localVarUrlObj = url.parse(localVarPath, true);
         ...
         * @throws {RequiredError}
         */
        recurringRunServiceListRecurringRuns(page_token?: string, page_size?: number, sort_by?: string, namespace?: string, filter?: string, experiment_id?: string, options: any = {}): FetchArgs {
            const localVarPath = `/apis/v2beta1/recurringruns`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const RecurringRunServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        recurringRunServiceCreateRecurringRun(recurring_run: V2beta1RecurringRun, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2beta1RecurringRun> {
            const localVarFetchArgs = RecurringRunServiceApiFetchParamCreator(configuration).recurringRunServiceCreateRecurringRun(recurring_run, options);
         ...
         * @throws {RequiredError}
         */
        recurringRunServiceDeleteRecurringRun(recurring_run_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = RecurringRunServiceApiFetchParamCreator(configuration).recurringRunServiceDeleteRecurringRun(recurring_run_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        recurringRunServiceDisableRecurringRun(recurring_run_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = RecurringRunServiceApiFetchParamCreator(configuration).recurringRunServiceDisableRecurringRun(recurring_run_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        recurringRunServiceEnableRecurringRun(recurring_run_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = RecurringRunServiceApiFetchParamCreator(configuration).recurringRunServiceEnableRecurringRun(recurring_run_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        recurringRunServiceGetRecurringRun(recurring_run_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2beta1RecurringRun> {
            const localVarFetchArgs = RecurringRunServiceApiFetchParamCreator(configuration).recurringRunServiceGetRecurringRun(recurring_run_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        recurringRunServiceListRecurringRuns(page_token?: string, page_size?: number, sort_by?: string, namespace?: string, filter?: string, experiment_id?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2beta1ListRecurringRunsResponse> {
            const localVarFetchArgs = RecurringRunServiceApiFetchParamCreator(configuration).recurringRunServiceListRecurringRuns(page_token, page_size, sort_by, namespace, filter, experiment_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
 ...
 * @export
 */
export const RecurringRunServiceApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Creates a new recurring run in an experiment, given the experiment ID.
        ...
        recurringRunServiceCreateRecurringRun(recurring_run: V2beta1RecurringRun, options?: any) {
            return RecurringRunServiceApiFp(configuration).recurringRunServiceCreateRecurringRun(recurring_run, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Deletes a recurring run.
        ...
        recurringRunServiceDeleteRecurringRun(recurring_run_id: string, options?: any) {
            return RecurringRunServiceApiFp(configuration).recurringRunServiceDeleteRecurringRun(recurring_run_id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Stops a recurring run and all its associated runs. The recurring run is not deleted.
        ...
        recurringRunServiceDisableRecurringRun(recurring_run_id: string, options?: any) {
            return RecurringRunServiceApiFp(configuration).recurringRunServiceDisableRecurringRun(recurring_run_id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Restarts a recurring run that was previously stopped. All runs associated with the  recurring run will continue.
        ...
        recurringRunServiceEnableRecurringRun(recurring_run_id: string, options?: any) {
            return RecurringRunServiceApiFp(configuration).recurringRunServiceEnableRecurringRun(recurring_run_id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Finds a specific recurring run by ID.
        ...
        recurringRunServiceGetRecurringRun(recurring_run_id: string, options?: any) {
            return RecurringRunServiceApiFp(configuration).recurringRunServiceGetRecurringRun(recurring_run_id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Finds all recurring runs given experiment and namespace.  If experiment ID is not specified, find all recurring runs across all experiments.
         ...
         * @throws {RequiredError}
         */
        recurringRunServiceListRecurringRuns(page_token?: string, page_size?: number, sort_by?: string, namespace?: string, filter?: string, experiment_id?: string, options?: any) {
            return RecurringRunServiceApiFp(configuration).recurringRunServiceListRecurringRuns(page_token, page_size, sort_by, namespace, filter, experiment_id, options)(fetch, basePath);
        },
    };
};
...
export class RecurringRunServiceApi extends BaseAPI {
    ...
    public recurringRunServiceCreateRecurringRun(recurring_run: V2beta1RecurringRun, options?: any) {
        return RecurringRunServiceApiFp(this.configuration).recurringRunServiceCreateRecurringRun(recurring_run, options)(this.fetch, this.basePath);
    }
    ...
    public recurringRunServiceDeleteRecurringRun(recurring_run_id: string, options?: any) {
        return RecurringRunServiceApiFp(this.configuration).recurringRunServiceDeleteRecurringRun(recurring_run_id, options)(this.fetch, this.basePath);
    }
    ...
    public recurringRunServiceDisableRecurringRun(recurring_run_id: string, options?: any) {
        return RecurringRunServiceApiFp(this.configuration).recurringRunServiceDisableRecurringRun(recurring_run_id, options)(this.fetch, this.basePath);
    }
    ...
    public recurringRunServiceEnableRecurringRun(recurring_run_id: string, options?: any) {
        return RecurringRunServiceApiFp(this.configuration).recurringRunServiceEnableRecurringRun(recurring_run_id, options)(this.fetch, this.basePath);
    }
    ...
    public recurringRunServiceGetRecurringRun(recurring_run_id: string, options?: any) {
        return RecurringRunServiceApiFp(this.configuration).recurringRunServiceGetRecurringRun(recurring_run_id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof RecurringRunServiceApi
     */
    public recurringRunServiceListRecurringRuns(page_token?: string, page_size?: number, sort_by?: string, namespace?: string, filter?: string, experiment_id?: string, options?: any) {
        return RecurringRunServiceApiFp(this.configuration).recurringRunServiceListRecurringRuns(page_token, page_size, sort_by, namespace, filter, experiment_id, options)(this.fetch, this.basePath);
    }
