    ...
    return {
        ...
        experimentServiceArchiveExperiment(experiment_id: string, options: any = {}): FetchArgs {
            ...
            if (experiment_id === null || experiment_id === undefined) {
                throw new RequiredError('experiment_id','Required parameter experiment_id was null or undefined when calling experimentServiceArchiveExperiment.');
            }
        ...
        experimentServiceCreateExperiment(experiment: V2beta1Experiment, options: any = {}): FetchArgs {
            ...
            if (experiment === null || experiment === undefined) {
                throw new RequiredError('experiment','Required parameter experiment was null or undefined when calling experimentServiceCreateExperiment.');
            }
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"V2beta1Experiment" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
        ...
        experimentServiceDeleteExperiment(experiment_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'experiment_id' is not null or undefined
            if (experiment_id === null || experiment_id === undefined) {
                throw new RequiredError('experiment_id','Required parameter experiment_id was null or undefined when calling experimentServiceDeleteExperiment.');
            }
        ...
        experimentServiceGetExperiment(experiment_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'experiment_id' is not null or undefined
            if (experiment_id === null || experiment_id === undefined) {
                throw new RequiredError('experiment_id','Required parameter experiment_id was null or undefined when calling experimentServiceGetExperiment.');
            }
            const localVarPath = `/apis/v2beta1/experiments/{experiment_id}`
                .replace(`{${"experiment_id"}}`, encodeURIComponent(String(experiment_id)));
            const localVarUrlObj = url.parse(localVarPath, true);
         ...
         * @throws {RequiredError}
         */
        experimentServiceListExperiments(page_token?: string, page_size?: number, sort_by?: string, filter?: string, namespace?: string, options: any = {}): FetchArgs {
            const localVarPath = `/apis/v2beta1/experiments`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
        ...
        experimentServiceUnarchiveExperiment(experiment_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'experiment_id' is not null or undefined
            if (experiment_id === null || experiment_id === undefined) {
                throw new RequiredError('experiment_id','Required parameter experiment_id was null or undefined when calling experimentServiceUnarchiveExperiment.');
            }
...
export const ExperimentServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        experimentServiceArchiveExperiment(experiment_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = ExperimentServiceApiFetchParamCreator(configuration).experimentServiceArchiveExperiment(experiment_id, options);
         ...
         * @throws {RequiredError}
         */
        experimentServiceCreateExperiment(experiment: V2beta1Experiment, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2beta1Experiment> {
            const localVarFetchArgs = ExperimentServiceApiFetchParamCreator(configuration).experimentServiceCreateExperiment(experiment, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        experimentServiceDeleteExperiment(experiment_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = ExperimentServiceApiFetchParamCreator(configuration).experimentServiceDeleteExperiment(experiment_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        experimentServiceGetExperiment(experiment_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2beta1Experiment> {
            const localVarFetchArgs = ExperimentServiceApiFetchParamCreator(configuration).experimentServiceGetExperiment(experiment_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        experimentServiceListExperiments(page_token?: string, page_size?: number, sort_by?: string, filter?: string, namespace?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<V2beta1ListExperimentsResponse> {
            const localVarFetchArgs = ExperimentServiceApiFetchParamCreator(configuration).experimentServiceListExperiments(page_token, page_size, sort_by, filter, namespace, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        experimentServiceUnarchiveExperiment(experiment_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = ExperimentServiceApiFetchParamCreator(configuration).experimentServiceUnarchiveExperiment(experiment_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const ExperimentServiceApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        experimentServiceArchiveExperiment(experiment_id: string, options?: any) {
            return ExperimentServiceApiFp(configuration).experimentServiceArchiveExperiment(experiment_id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Creates a new experiment.
        ...
        experimentServiceCreateExperiment(experiment: V2beta1Experiment, options?: any) {
            return ExperimentServiceApiFp(configuration).experimentServiceCreateExperiment(experiment, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Deletes an experiment without deleting the experiment's runs and recurring  runs. To avoid unexpected behaviors, delete an experiment's runs and recurring  runs before deleting the experiment.
        ...
        experimentServiceDeleteExperiment(experiment_id: string, options?: any) {
            return ExperimentServiceApiFp(configuration).experimentServiceDeleteExperiment(experiment_id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Finds a specific experiment by ID.
        ...
        experimentServiceGetExperiment(experiment_id: string, options?: any) {
            return ExperimentServiceApiFp(configuration).experimentServiceGetExperiment(experiment_id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Finds all experiments. Supports pagination, and sorting on certain fields.
         ...
         * @throws {RequiredError}
         */
        experimentServiceListExperiments(page_token?: string, page_size?: number, sort_by?: string, filter?: string, namespace?: string, options?: any) {
            return ExperimentServiceApiFp(configuration).experimentServiceListExperiments(page_token, page_size, sort_by, filter, namespace, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Restores an archived experiment. The experiment's archived runs and recurring runs will stay archived.
        ...
        experimentServiceUnarchiveExperiment(experiment_id: string, options?: any) {
            return ExperimentServiceApiFp(configuration).experimentServiceUnarchiveExperiment(experiment_id, options)(fetch, basePath);
        },
    };
};
...
export class ExperimentServiceApi extends BaseAPI {
    ...
    public experimentServiceArchiveExperiment(experiment_id: string, options?: any) {
        return ExperimentServiceApiFp(this.configuration).experimentServiceArchiveExperiment(experiment_id, options)(this.fetch, this.basePath);
    }
    ...
    public experimentServiceCreateExperiment(experiment: V2beta1Experiment, options?: any) {
        return ExperimentServiceApiFp(this.configuration).experimentServiceCreateExperiment(experiment, options)(this.fetch, this.basePath);
    }
    ...
    public experimentServiceDeleteExperiment(experiment_id: string, options?: any) {
        return ExperimentServiceApiFp(this.configuration).experimentServiceDeleteExperiment(experiment_id, options)(this.fetch, this.basePath);
    }
    ...
    public experimentServiceGetExperiment(experiment_id: string, options?: any) {
        return ExperimentServiceApiFp(this.configuration).experimentServiceGetExperiment(experiment_id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof ExperimentServiceApi
     */
    public experimentServiceListExperiments(page_token?: string, page_size?: number, sort_by?: string, filter?: string, namespace?: string, options?: any) {
        return ExperimentServiceApiFp(this.configuration).experimentServiceListExperiments(page_token, page_size, sort_by, filter, namespace, options)(this.fetch, this.basePath);
    }
    ...
    public experimentServiceUnarchiveExperiment(experiment_id: string, options?: any) {
        return ExperimentServiceApiFp(this.configuration).experimentServiceUnarchiveExperiment(experiment_id, options)(this.fetch, this.basePath);
    }
