...
export const RunServiceApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        runServiceArchiveRunV1(id: string, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling runServiceArchiveRunV1.');
            }
         ...
         * @throws {RequiredError}
         */
        runServiceCreateRunV1(run: ApiRun, options: any = {}): FetchArgs {
            // verify required parameter 'run' is not null or undefined
            if (run === null || run === undefined) {
                throw new RequiredError('run','Required parameter run was null or undefined when calling runServiceCreateRunV1.');
            }
         ...
         * @throws {RequiredError}
         */
        runServiceDeleteRunV1(id: string, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling runServiceDeleteRunV1.');
            }
         ...
         * @throws {RequiredError}
         */
        runServiceGetRunV1(run_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'run_id' is not null or undefined
            if (run_id === null || run_id === undefined) {
                throw new RequiredError('run_id','Required parameter run_id was null or undefined when calling runServiceGetRunV1.');
            }
         ...
         * @throws {RequiredError}
         */
        runServiceListRunsV1(page_token?: string, page_size?: number, sort_by?: string, resource_reference_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION' | 'NAMESPACE', resource_reference_key_id?: string, filter?: string, options: any = {}): FetchArgs {
            const localVarPath = `/apis/v1beta1/runs`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
         ...
         * @throws {RequiredError}
         */
        runServiceReportRunMetricsV1(run_id: string, body: RunServiceReportRunMetricsV1Body, options: any = {}): FetchArgs {
            // verify required parameter 'run_id' is not null or undefined
            if (run_id === null || run_id === undefined) {
                throw new RequiredError('run_id','Required parameter run_id was null or undefined when calling runServiceReportRunMetricsV1.');
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling runServiceReportRunMetricsV1.');
            }
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"RunServiceReportRunMetricsV1Body" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
         ...
         * @throws {RequiredError}
         */
        runServiceRetryRunV1(run_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'run_id' is not null or undefined
            if (run_id === null || run_id === undefined) {
                throw new RequiredError('run_id','Required parameter run_id was null or undefined when calling runServiceRetryRunV1.');
            }
         ...
         * @throws {RequiredError}
         */
        runServiceTerminateRunV1(run_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'run_id' is not null or undefined
            if (run_id === null || run_id === undefined) {
                throw new RequiredError('run_id','Required parameter run_id was null or undefined when calling runServiceTerminateRunV1.');
            }
         ...
         * @throws {RequiredError}
         */
        runServiceUnarchiveRunV1(id: string, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling runServiceUnarchiveRunV1.');
            }
...
export const RunServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        runServiceArchiveRunV1(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = RunServiceApiFetchParamCreator(configuration).runServiceArchiveRunV1(id, options);
         ...
         * @throws {RequiredError}
         */
        runServiceCreateRunV1(run: ApiRun, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiRunDetail> {
            const localVarFetchArgs = RunServiceApiFetchParamCreator(configuration).runServiceCreateRunV1(run, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        runServiceDeleteRunV1(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = RunServiceApiFetchParamCreator(configuration).runServiceDeleteRunV1(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        runServiceGetRunV1(run_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiRunDetail> {
            const localVarFetchArgs = RunServiceApiFetchParamCreator(configuration).runServiceGetRunV1(run_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        runServiceListRunsV1(page_token?: string, page_size?: number, sort_by?: string, resource_reference_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION' | 'NAMESPACE', resource_reference_key_id?: string, filter?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiListRunsResponse> {
            const localVarFetchArgs = RunServiceApiFetchParamCreator(configuration).runServiceListRunsV1(page_token, page_size, sort_by, resource_reference_key_type, resource_reference_key_id, filter, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        runServiceReportRunMetricsV1(run_id: string, body: RunServiceReportRunMetricsV1Body, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiReportRunMetricsResponse> {
            const localVarFetchArgs = RunServiceApiFetchParamCreator(configuration).runServiceReportRunMetricsV1(run_id, body, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        runServiceRetryRunV1(run_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = RunServiceApiFetchParamCreator(configuration).runServiceRetryRunV1(run_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        runServiceTerminateRunV1(run_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = RunServiceApiFetchParamCreator(configuration).runServiceTerminateRunV1(run_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        runServiceUnarchiveRunV1(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = RunServiceApiFetchParamCreator(configuration).runServiceUnarchiveRunV1(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const RunServiceApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        runServiceArchiveRunV1(id: string, options?: any) {
            return RunServiceApiFp(configuration).runServiceArchiveRunV1(id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Creates a new run.
         ...
         * @throws {RequiredError}
         */
        runServiceCreateRunV1(run: ApiRun, options?: any) {
            return RunServiceApiFp(configuration).runServiceCreateRunV1(run, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Deletes a run.
         ...
         * @throws {RequiredError}
         */
        runServiceDeleteRunV1(id: string, options?: any) {
            return RunServiceApiFp(configuration).runServiceDeleteRunV1(id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Finds a specific run by ID.
         ...
         * @throws {RequiredError}
         */
        runServiceGetRunV1(run_id: string, options?: any) {
            return RunServiceApiFp(configuration).runServiceGetRunV1(run_id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Finds all runs.
         ...
         * @throws {RequiredError}
         */
        runServiceListRunsV1(page_token?: string, page_size?: number, sort_by?: string, resource_reference_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION' | 'NAMESPACE', resource_reference_key_id?: string, filter?: string, options?: any) {
            return RunServiceApiFp(configuration).runServiceListRunsV1(page_token, page_size, sort_by, resource_reference_key_type, resource_reference_key_id, filter, options)(fetch, basePath);
        },
        /**
         * 
         * @summary ReportRunMetrics reports metrics of a run. Each metric is reported in its own transaction, so this API accepts partial failures. Metric can be uniquely identified by (run_id, node_id, name). Duplicate reporting will be ignored by the API. First reporting wins.
         ...
         * @throws {RequiredError}
         */
        runServiceReportRunMetricsV1(run_id: string, body: RunServiceReportRunMetricsV1Body, options?: any) {
            return RunServiceApiFp(configuration).runServiceReportRunMetricsV1(run_id, body, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Re-initiates a failed or terminated run.
         ...
         * @throws {RequiredError}
         */
        runServiceRetryRunV1(run_id: string, options?: any) {
            return RunServiceApiFp(configuration).runServiceRetryRunV1(run_id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Terminates an active run.
         ...
         * @throws {RequiredError}
         */
        runServiceTerminateRunV1(run_id: string, options?: any) {
            return RunServiceApiFp(configuration).runServiceTerminateRunV1(run_id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Restores an archived run.
         ...
         * @throws {RequiredError}
         */
        runServiceUnarchiveRunV1(id: string, options?: any) {
            return RunServiceApiFp(configuration).runServiceUnarchiveRunV1(id, options)(fetch, basePath);
        },
    };
};
...
export class RunServiceApi extends BaseAPI {
     ...
     */
    public runServiceArchiveRunV1(id: string, options?: any) {
        return RunServiceApiFp(this.configuration).runServiceArchiveRunV1(id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof RunServiceApi
     */
    public runServiceCreateRunV1(run: ApiRun, options?: any) {
        return RunServiceApiFp(this.configuration).runServiceCreateRunV1(run, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof RunServiceApi
     */
    public runServiceDeleteRunV1(id: string, options?: any) {
        return RunServiceApiFp(this.configuration).runServiceDeleteRunV1(id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof RunServiceApi
     */
    public runServiceGetRunV1(run_id: string, options?: any) {
        return RunServiceApiFp(this.configuration).runServiceGetRunV1(run_id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof RunServiceApi
     */
    public runServiceReportRunMetricsV1(run_id: string, body: RunServiceReportRunMetricsV1Body, options?: any) {
        return RunServiceApiFp(this.configuration).runServiceReportRunMetricsV1(run_id, body, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof RunServiceApi
     */
    public runServiceRetryRunV1(run_id: string, options?: any) {
        return RunServiceApiFp(this.configuration).runServiceRetryRunV1(run_id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof RunServiceApi
     */
    public runServiceTerminateRunV1(run_id: string, options?: any) {
        return RunServiceApiFp(this.configuration).runServiceTerminateRunV1(run_id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof RunServiceApi
     */
    public runServiceUnarchiveRunV1(id: string, options?: any) {
        return RunServiceApiFp(this.configuration).runServiceUnarchiveRunV1(id, options)(this.fetch, this.basePath);
    }
