...
export interface ApiJob {
    ...
    description?: string;
    /**
     * Optional input field. Describing what the pipeline manifest and parameters to use for the scheduled job. If unset, fetch the pipline_spec at runtime.
...
export const JobServiceApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {ApiJob} job The job to be created
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        jobServiceCreateJob(job: ApiJob, options: any = {}): FetchArgs {
            // verify required parameter 'job' is not null or undefined
            if (job === null || job === undefined) {
                throw new RequiredError('job','Required parameter job was null or undefined when calling jobServiceCreateJob.');
            }
         ...
         * @throws {RequiredError}
         */
        jobServiceDeleteJob(id: string, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling jobServiceDeleteJob.');
            }
         ...
         * @throws {RequiredError}
         */
        jobServiceDisableJob(id: string, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling jobServiceDisableJob.');
            }
         ...
         * @throws {RequiredError}
         */
        jobServiceEnableJob(id: string, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling jobServiceEnableJob.');
            }
         ...
         * @throws {RequiredError}
         */
        jobServiceGetJob(id: string, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling jobServiceGetJob.');
            }
            const localVarPath = `/apis/v1beta1/jobs/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = url.parse(localVarPath, true);
         ...
         * @throws {RequiredError}
         */
        jobServiceListJobs(page_token?: string, page_size?: number, sort_by?: string, resource_reference_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION' | 'NAMESPACE', resource_reference_key_id?: string, filter?: string, options: any = {}): FetchArgs {
            const localVarPath = `/apis/v1beta1/jobs`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const JobServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        jobServiceCreateJob(job: ApiJob, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiJob> {
            const localVarFetchArgs = JobServiceApiFetchParamCreator(configuration).jobServiceCreateJob(job, options);
         ...
         * @throws {RequiredError}
         */
        jobServiceDeleteJob(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = JobServiceApiFetchParamCreator(configuration).jobServiceDeleteJob(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        jobServiceDisableJob(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = JobServiceApiFetchParamCreator(configuration).jobServiceDisableJob(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        jobServiceEnableJob(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = JobServiceApiFetchParamCreator(configuration).jobServiceEnableJob(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        jobServiceGetJob(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiJob> {
            const localVarFetchArgs = JobServiceApiFetchParamCreator(configuration).jobServiceGetJob(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        jobServiceListJobs(page_token?: string, page_size?: number, sort_by?: string, resource_reference_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION' | 'NAMESPACE', resource_reference_key_id?: string, filter?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiListJobsResponse> {
            const localVarFetchArgs = JobServiceApiFetchParamCreator(configuration).jobServiceListJobs(page_token, page_size, sort_by, resource_reference_key_type, resource_reference_key_id, filter, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const JobServiceApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        jobServiceCreateJob(job: ApiJob, options?: any) {
            return JobServiceApiFp(configuration).jobServiceCreateJob(job, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Deletes a job.
         ...
         * @throws {RequiredError}
         */
        jobServiceDeleteJob(id: string, options?: any) {
            return JobServiceApiFp(configuration).jobServiceDeleteJob(id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Stops a job and all its associated runs. The job is not deleted.
         ...
         * @throws {RequiredError}
         */
        jobServiceDisableJob(id: string, options?: any) {
            return JobServiceApiFp(configuration).jobServiceDisableJob(id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Restarts a job that was previously stopped. All runs associated with the job will continue.
         ...
         * @throws {RequiredError}
         */
        jobServiceEnableJob(id: string, options?: any) {
            return JobServiceApiFp(configuration).jobServiceEnableJob(id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Finds a specific job by ID.
         ...
         * @throws {RequiredError}
         */
        jobServiceGetJob(id: string, options?: any) {
            return JobServiceApiFp(configuration).jobServiceGetJob(id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Finds all jobs.
         ...
         * @throws {RequiredError}
         */
        jobServiceListJobs(page_token?: string, page_size?: number, sort_by?: string, resource_reference_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION' | 'NAMESPACE', resource_reference_key_id?: string, filter?: string, options?: any) {
            return JobServiceApiFp(configuration).jobServiceListJobs(page_token, page_size, sort_by, resource_reference_key_type, resource_reference_key_id, filter, options)(fetch, basePath);
        },
    };
};
...
export class JobServiceApi extends BaseAPI {
     ...
     */
    public jobServiceCreateJob(job: ApiJob, options?: any) {
        return JobServiceApiFp(this.configuration).jobServiceCreateJob(job, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof JobServiceApi
     */
    public jobServiceDeleteJob(id: string, options?: any) {
        return JobServiceApiFp(this.configuration).jobServiceDeleteJob(id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof JobServiceApi
     */
    public jobServiceDisableJob(id: string, options?: any) {
        return JobServiceApiFp(this.configuration).jobServiceDisableJob(id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof JobServiceApi
     */
    public jobServiceEnableJob(id: string, options?: any) {
        return JobServiceApiFp(this.configuration).jobServiceEnableJob(id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof JobServiceApi
     */
    public jobServiceGetJob(id: string, options?: any) {
        return JobServiceApiFp(this.configuration).jobServiceGetJob(id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof JobServiceApi
     */
    public jobServiceListJobs(page_token?: string, page_size?: number, sort_by?: string, resource_reference_key_type?: 'UNKNOWN_RESOURCE_TYPE' | 'EXPERIMENT' | 'JOB' | 'PIPELINE' | 'PIPELINE_VERSION' | 'NAMESPACE', resource_reference_key_id?: string, filter?: string, options?: any) {
        return JobServiceApiFp(this.configuration).jobServiceListJobs(page_token, page_size, sort_by, resource_reference_key_type, resource_reference_key_id, filter, options)(this.fetch, this.basePath);
    }
